...
<html lang="en">
    <head>
        ...
        <!-- Vendor CSS Files -->
        <link
            href="{{ asset('kelly') }}/assets/vendor/bootstrap/css/bootstrap.min.css"
            rel="stylesheet"
        />
        <link
            href="{{ asset('kelly') }}/assets/vendor/bootstrap-icons/bootstrap-icons.css"
            rel="stylesheet"
        />
        <link href="{{ asset('kelly') }}/assets/vendor/aos/aos.css" rel="stylesheet" />
        <link
            href="{{ asset('kelly') }}/assets/vendor/swiper/swiper-bundle.min.css"
            rel="stylesheet"
        />
        <link
            href="{{ asset('kelly') }}/assets/vendor/glightbox/css/glightbox.min.css"
            rel="stylesheet"
        />
                ...
                >
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <h2>Kelly Adams</h2>
                            <p>
                                I'm a professional illustrator from San
                                Francisco
                            </p>
